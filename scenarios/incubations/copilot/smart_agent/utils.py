...
openai.api_key =  "e611d5138b174f66964bf071f7fbb4a6"#os.environ.get("AZURE_OPENAI_API_KEY")
openai.api_base =  "https://cog-dtfccxq6x2aiy.openai.azure.com"#os.environ.get("AZURE_OPENAI_ENDPOINT")
openai.api_type = "azure"
emb_engine = "embedding"#os.getenv("AZURE_OPENAI_EMB_DEPLOYMENT")
emb_engine = emb_engine.strip('"')

#azcs implementation
service_endpoint = "https://gptkb-dtfccxq6x2aiy.search.windows.net"#os.getenv("AZURE_SEARCH_SERVICE_ENDPOINT") 
index_name = "gptkbindex"#os.getenv("AZURE_SEARCH_INDEX_NAME") 
index_name = index_name.strip('"')
key = "QLSBPUgjAzOErodCxiJM85D01Myqc5iG2dsJXhJ8bdAzSeBxC8Mt"#os.getenv("AZURE_SEARCH_ADMIN_KEY") 
key = key.strip('"')
...
def get_cache(search_query):
    ...
    try:
        ...
        if result['@search.score']>= float(0.9):
...
class Agent(): #Base class for Agent
    ...
    def generate_response(self, new_input,history=None, stream = False,request_timeout =20,api_version = "2023-05-15"):
        ...
        chatgpt_args = {"deployment_id": "chat"} 
...
class Smart_Agent(Agent):
    ...
    """
    def __init__(self, persona,functions_spec, functions_list, name=None, init_message=None, engine ="chat"):
